...
public class WelcomeGuideActivity extends Activity implements View.OnClickListener {
    ...
    // 引导页图片资源
    private static final int[] pics = { R.layout.fragment_intro_1,
            R.layout.fragment_intro_2, R.layout.fragment_intro_3};
...
//        SharedPreferencesUtil.putBoolean(WelcomeGuideActivity.this, SharedPreferencesUtil.FIRST_OPEN, false);
    ...
    private void initDots() {
        LinearLayout ll = (LinearLayout) findViewById(R.id.ll_intro);
