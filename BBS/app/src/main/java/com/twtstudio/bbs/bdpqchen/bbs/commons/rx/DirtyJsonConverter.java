...
public class DirtyJsonConverter extends Converter.Factory {
    ...
    public static DirtyJsonConverter create() {
        return create(new Gson());
    }

    public static DirtyJsonConverter create(Gson gson) {
        return new DirtyJsonConverter(gson);
    }

    private final Gson gson;

    private DirtyJsonConverter(Gson gson) {
